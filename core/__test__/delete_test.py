...
class TestDeleteFile(TestCase):
    ...
    @patch('core.delete.refresh_index')
    @patch('core.delete.dataset_exists')
    @patch('core.delete.EsConnection')
    def test_delete_file_by_name_query_called_with_correct_args(self, mock_es_conn, mock_dataset_exists, mock_refresh_index):
...
class TestDeleteDataset(TestCase):
    ...
    @patch('core.delete.dataset_exists')
    @patch('core.delete.EsConnection')
    def test_delete_dataset_by_name_query_called_with_correct_args(self, mock_es_conn, mock_dataset_exists, mock_refresh_index):
        mock_dataset_exists.return_value = True
        mock_es_conn.return_value = mock_es_conn
        mock_es_conn.index_name = "face_embeddings"
