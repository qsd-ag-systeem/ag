export default function AppIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      version="1.1"
      id="Laag_1"
      ...
      y="0px"
      viewBox="0 0 190 70"
      enableBackground="new 0 0 190 70"
      xmlSpace="preserve"
      {...props}
    >
      <polygon
      ...
      <g>
        <path
          fill="#004682"
          d="M9.5,44.1l-1.7,0v-9.7h1.7c2.3,0,4.4,2.2,4.4,4.8C13.9,41.9,11.9,44.1,9.5,44.1 M9.1,29.7h-8v25.2h6.7v-5.6   l2,0c6.7,0.2,10.7-4.7,10.6-9.9C20.3,33.6,16.8,29.7,9.1,29.7"
        />
        <path
          fill="#004682"
          d="M51,50.9c0.9,1.2,1.4,2.7,1.4,4.2c0,4-3.2,7.2-7.2,7.2s-7.2-3.2-7.2-7.2c0-1.6,0.5-3,1.4-4.2l-5.2-4.3   c-1.8,2.4-2.9,5.3-2.9,8.5c0,7.7,6.3,14,14,14c7.7,0,14-6.3,14-14c0-3.2-1.1-6.2-2.9-8.6L51,50.9z"
        />
        <path
          fill="#BE965A"
